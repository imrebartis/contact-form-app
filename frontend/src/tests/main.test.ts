...
describe('ContactForm', () => {
  ...
  it('should validate specific fields and show errors only for those fields', async () => {
    ...
    // Manually update error classes to simulate validation
    firstNameError.classList.remove('error-visible');
    ...
    lastNameError.classList.remove('error-visible');
