...
// filepath: frontend/src/utils/router.test.ts
...
// Add a method to reset the Router singleton for testing
...
describe('Router', () => {
  ...
  beforeEach(() => {
    ...
    // Mock pushState directly (this is the key fix)
  ...
  describe('navigateTo', () => {
    ...
    it('should handle OAuth paths correctly', () => {
      ...
      // API paths are passed through unchanged in the current implementation
      expect(mockHistoryPushState).toHaveBeenCalledWith(
        {},
        '',
        '/api/auth/callback'
